...
from mobilenetv1 import DwCBN
from mobilenetv1 import CBN

# 定义样例数据+网络
# data = torch.randn(1, 3, 224, 224)
# net = models.resnet18()
#
# torch.onnx.export(net,data,'resnet18.onnx',export_params=True,opset_version=11)
#
...
#
#
# onnx.save(model1,'new.onnx')

# data = torch.randn(1, 3, 224, 224)
# net = torch.load('mobilenetv1.pth')
#
# torch.onnx.export(net,data,'mobilenetV1.onnx',export_params=True,opset_version=11)
#
# model = onnx.load('mobilenetV1.onnx')
# #
#
# model1 = onnx.shape_inference.infer_shapes(model)
#
#
# onnx.save(model1,'new1.onnx')

# data = torch.randn(1, 3, 224, 224)
# net = models.mobilenet_v2()
#
# torch.onnx.export(net,data,'mobilenetv2.onnx',export_params=True,opset_version=11)
#
...
#
#
# onnx.save(model1,'mobilenetv2new.onnx')
