...
//				}
	...
	//							break;
							case 1:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img2 + ((DeviceId + 4 - i) % 4) * output_channel[1]*img_height[2]*img_width[2] / 4, (uint32_t)s->io->output_img2 + ((DeviceId + 4 - i) % 4) * output_channel[1]*img_height[2]*img_width[2] / 4, output_channel[1]*img_height[2]*img_width[2]);
								break;
	//						case 2:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img3 + ((DeviceId + 4 - i) % 4) * output_channel[2]*img_height[3]*img_width[3] / 4, (uint32_t)s->io->output_img3 + ((DeviceId + 4 - i) % 4) * output_channel[2]*img_height[3]*img_width[3] / 4, output_channel[2]*img_height[3]*img_width[3]);
	//							break;
							case 3:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img4 + ((DeviceId + 4 - i) % 4) * output_channel[3]*img_height[4]*img_width[4] / 4, (uint32_t)s->io->output_img4 + ((DeviceId + 4 - i) % 4) * output_channel[3]*img_height[4]*img_width[4] / 4, output_channel[3]*img_height[4]*img_width[4]);
								break;
	//						case 4:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img5 + ((DeviceId + 4 - i) % 4) * output_channel[4]*img_height[5]*img_width[5] / 4, (uint32_t)s->io->output_img5 + ((DeviceId + 4 - i) % 4) * output_channel[4]*img_height[5]*img_width[5] / 4, output_channel[4]*img_height[5]*img_width[5]);
	//							break;
							case 5:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img6 + ((DeviceId + 4 - i) % 4) * output_channel[5]*img_height[6]*img_width[6] / 4, (uint32_t)s->io->output_img6 + ((DeviceId + 4 - i) % 4) * output_channel[5]*img_height[6]*img_width[6] / 4, output_channel[5]*img_height[6]*img_width[6]);
								break;
	//						case 6:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img7 + ((DeviceId + 4 - i) % 4) * output_channel[6]*img_height[7]*img_width[7] / 4, (uint32_t)s->io->output_img7 + ((DeviceId + 4 - i) % 4) * output_channel[6]*img_height[7]*img_width[7] / 4, output_channel[6]*img_height[7]*img_width[7]);
	//							break;
							case 7:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img8 + ((DeviceId + 4 - i) % 4) * output_channel[7]*img_height[8]*img_width[8] / 4, (uint32_t)s->io->output_img8 + ((DeviceId + 4 - i) % 4) * output_channel[7]*img_height[8]*img_width[8] / 4, output_channel[7]*img_height[8]*img_width[8]);
								break;
	//						case 8:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img9 + ((DeviceId + 4 - i) % 4) * output_channel[8]*img_height[9]*img_width[9] / 4, (uint32_t)s->io->output_img9 + ((DeviceId + 4 - i) % 4) * output_channel[8]*img_height[9]*img_width[9] / 4, output_channel[8]*img_height[9]*img_width[9]);
	//							break;
							case 9:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img10 + ((DeviceId + 4 - i) % 4) * output_channel[9]*img_height[10]*img_width[10] / 4,  (uint32_t)s->io->output_img10 + ((DeviceId + 4 - i) % 4) * output_channel[9]*img_height[10]*img_width[10] / 4, output_channel[9]*img_height[10]*img_width[10]);
								break;
	//						case 10:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img11 + ((DeviceId + 4 - i) % 4) * output_channel[10]*img_height[11]*img_width[11] / 4, (uint32_t)s->io->output_img11 + ((DeviceId + 4 - i) % 4) * output_channel[10]*img_height[11]*img_width[11] / 4, output_channel[10]*img_height[11]*img_width[11]);
	//							break;
							case 11:
								SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img12 + ((DeviceId + 4 - i) % 4) * output_channel[11]*img_height[12]*img_width[12] / 4, (uint32_t)s->io->output_img12 + ((DeviceId + 4 - i) % 4) * output_channel[11]*img_height[12]*img_width[12] / 4, output_channel[11]*img_height[12]*img_width[12]);
								break;
	//						case 12:
	...
	//							break;
							case 25:
								...
								break;
	//						case 26:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img27 + ((DeviceId + 4 - i) % 4) * output_channel[17]*img_height[18]*img_width[18] / 4, (uint32_t)s->io->output_img27 + ((DeviceId + 4 - i) % 4) * output_channel[17]*img_height[18]*img_width[18] / 4, output_channel[17]*img_height[18]*img_width[18] / 4);
	//							break;
	//						case 27:
	//							SrioSendData(DeviceId, (DeviceId + 5) % 4,  (uint32_t)s->io->output_img28 + ((DeviceId + 4 - i) % 4) * output_channel[18]*img_height[19]*img_width[19] / 4, (uint32_t)s->io->output_img28 + ((DeviceId + 4 - i) % 4) * output_channel[18]*img_height[19]*img_width[19] / 4, output_channel[18]*img_height[19]*img_width[19] / 4);
	//							break;
	//						case 28:
...
//							break;
						case 1:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img2 + DeviceId * output_channel[1]*img_height[2]*img_width[2] / 4, (uint32_t)s->io->output_img2 + DeviceId * output_channel[1]*img_height[2]*img_width[2] / 4, output_channel[1]*img_height[2]*img_width[2]);
							break;
//						case 2:
//							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img3 + DeviceId * output_channel[2]*img_height[3]*img_width[3] / 4, (uint32_t)s->io->output_img3 + DeviceId * output_channel[2]*img_height[3]*img_width[3] / 4, output_channel[2]*img_height[3]*img_width[3]);
//							break;
						case 3:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img4 + DeviceId * output_channel[3]*img_height[4]*img_width[4] / 4, (uint32_t)s->io->output_img4 + DeviceId * output_channel[3]*img_height[4]*img_width[4] / 4, output_channel[3]*img_height[4]*img_width[4]);
							break;
//						case 4:
//							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img5 + DeviceId * output_channel[4]*img_height[5]*img_width[5] / 4, (uint32_t)s->io->output_img5 + DeviceId * output_channel[4]*img_height[5]*img_width[5] / 4, output_channel[4]*img_height[5]*img_width[5]);
//							break;
						case 5:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img6 + DeviceId * output_channel[5]*img_height[6]*img_width[6] / 4, (uint32_t)s->io->output_img6 + DeviceId * output_channel[5]*img_height[6]*img_width[6] / 4, output_channel[5]*img_height[6]*img_width[6]);
							break;
//						case 6:
//							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img7 + DeviceId * output_channel[6]*img_height[7]*img_width[7] / 4, (uint32_t)s->io->output_img7 + DeviceId * output_channel[6]*img_height[7]*img_width[7] / 4, output_channel[6]*img_height[7]*img_width[7]);
//							break;
						case 7:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img8 + DeviceId * output_channel[7]*img_height[8]*img_width[8] / 4, (uint32_t)s->io->output_img8 + DeviceId * output_channel[7]*img_height[8]*img_width[8] / 4, output_channel[7]*img_height[8]*img_width[8]);
							break;
//						case 8:
//							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img9 + DeviceId * output_channel[8]*img_height[9]*img_width[9] / 4, (uint32_t)s->io->output_img9 + DeviceId * output_channel[8]*img_height[9]*img_width[9] / 4, output_channel[8]*img_height[9]*img_width[9]);
//							break;
						case 9:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img10 + DeviceId * output_channel[9]*img_height[10]*img_width[10] / 4,  (uint32_t)s->io->output_img10 + DeviceId * output_channel[9]*img_height[10]*img_width[10] / 4, output_channel[9]*img_height[10]*img_width[10]);
							break;
//						case 10:
//							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img11 + DeviceId * output_channel[10]*img_height[11]*img_width[11] / 4, (uint32_t)s->io->output_img11 + DeviceId * output_channel[10]*img_height[11]*img_width[11] / 4, output_channel[10]*img_height[11]*img_width[11]);
//							break;
						case 11:
							SrioSendData(DeviceId, 0,  (uint32_t)s->io->output_img12 + DeviceId * output_channel[11]*img_height[12]*img_width[12] / 4, (uint32_t)s->io->output_img12 + DeviceId * output_channel[11]*img_height[12]*img_width[12] / 4, output_channel[11]*img_height[12]*img_width[12]);
							break;
//						case 12:
...
//									break;
								case 1:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img2 + ((i+j+5) % 4) * output_channel[1]*img_height[2]*img_width[2] / 4, (uint32_t)s->io->output_img2 + ((i+j+5) % 4) * output_channel[1]*img_height[2]*img_width[2] / 4, output_channel[1]*img_height[2]*img_width[2]);
									break;
//								case 2:
//									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img3 + ((i+j+5) % 4) * output_channel[2]*img_height[3]*img_width[3] / 4, (uint32_t)s->io->output_img3 + ((i+j+5) % 4) * output_channel[2]*img_height[3]*img_width[3] / 4, output_channel[2]*img_height[3]*img_width[3]);
//									break;
								case 3:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img4 + ((i+j+5) % 4) * output_channel[3]*img_height[4]*img_width[4] / 4, (uint32_t)s->io->output_img4 + ((i+j+5) % 4) * output_channel[3]*img_height[4]*img_width[4] / 4, output_channel[3]*img_height[4]*img_width[4]);
									break;
//								case 4:
//									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img5 + ((i+j+5) % 4) * output_channel[4]*img_height[5]*img_width[5] / 4, (uint32_t)s->io->output_img5 + ((i+j+5) % 4) * output_channel[4]*img_height[5]*img_width[5] / 4, output_channel[4]*img_height[5]*img_width[5]);
//									break;
								case 5:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img6 + ((i+j+5) % 4) * output_channel[5]*img_height[6]*img_width[6] / 4, (uint32_t)s->io->output_img6 + ((i+j+5) % 4) * output_channel[5]*img_height[6]*img_width[6] / 4, output_channel[5]*img_height[6]*img_width[6]);
									break;
//								case 6:
//									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img7 + ((i+j+5) % 4) * output_channel[6]*img_height[7]*img_width[7] / 4, (uint32_t)s->io->output_img7 + ((i+j+5) % 4) * output_channel[6]*img_height[7]*img_width[7] / 4, output_channel[6]*img_height[7]*img_width[7]);
//									break;
								case 7:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img8 + ((i+j+5) % 4) * output_channel[7]*img_height[8]*img_width[8] / 4, (uint32_t)s->io->output_img8 + ((i+j+5) % 4) * output_channel[7]*img_height[8]*img_width[8] / 4, output_channel[7]*img_height[8]*img_width[8]);
									break;
//								case 8:
//									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img9 + ((i+j+5) % 4) * output_channel[8]*img_height[9]*img_width[9] / 4, (uint32_t)s->io->output_img9 + ((i+j+5) % 4) * output_channel[8]*img_height[9]*img_width[9] / 4, output_channel[8]*img_height[9]*img_width[9]);
//									break;
								case 9:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img10 + ((i+j+5) % 4) * output_channel[9]*img_height[10]*img_width[10] / 4,  (uint32_t)s->io->output_img10 + ((i+j+5) % 4) * output_channel[9]*img_height[10]*img_width[10] / 4, output_channel[9]*img_height[10]*img_width[10]);
									break;
//								case 10:
//									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img11 + ((i+j+5) % 4) * output_channel[10]*img_height[11]*img_width[11] / 4, (uint32_t)s->io->output_img11 + ((i+j+5) % 4) * output_channel[10]*img_height[11]*img_width[11] / 4, output_channel[10]*img_height[11]*img_width[11]);
//									break;
								case 11:
									SrioSendData(DeviceId, i,  (uint32_t)s->io->output_img12 + ((i+j+5) % 4) * output_channel[11]*img_height[12]*img_width[12] / 4, (uint32_t)s->io->output_img12 + ((i+j+5) % 4) * output_channel[11]*img_height[12]*img_width[12] / 4, output_channel[11]*img_height[12]*img_width[12]);
									break;
//								case 12:
...
//									break;
				...
				for(int i = 0;i < 3;i++)
				{
					...
					{
						case 1:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img2 + DeviceId * output_channel[1]*img_height[2]*img_width[2] / 4, (uint32_t)s->io->output_img2 + DeviceId * output_channel[1]*img_height[2]*img_width[2] / 4, output_channel[1]*img_height[2]*img_width[2]);
							break;
						case 3:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img4 + DeviceId * output_channel[3]*img_height[4]*img_width[4] / 4, (uint32_t)s->io->output_img4 + DeviceId * output_channel[3]*img_height[4]*img_width[4] / 4, output_channel[3]*img_height[4]*img_width[4]);
							break;
						case 5:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img6 + DeviceId * output_channel[5]*img_height[6]*img_width[6] / 4, (uint32_t)s->io->output_img6 + DeviceId * output_channel[5]*img_height[6]*img_width[6] / 4, output_channel[5]*img_height[6]*img_width[6]);
							break;
						case 7:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img8 + DeviceId * output_channel[7]*img_height[8]*img_width[8] / 4, (uint32_t)s->io->output_img8 + DeviceId * output_channel[7]*img_height[8]*img_width[8] / 4, output_channel[7]*img_height[8]*img_width[8]);
							break;
						case 9:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img10 + DeviceId * output_channel[9]*img_height[10]*img_width[10] / 4,  (uint32_t)s->io->output_img10 + DeviceId * output_channel[9]*img_height[10]*img_width[10] / 4, output_channel[9]*img_height[10]*img_width[10]);
							break;
						case 11:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img12 + DeviceId * output_channel[11]*img_height[12]*img_width[12] / 4, (uint32_t)s->io->output_img12 + DeviceId * output_channel[11]*img_height[12]*img_width[12] / 4, output_channel[11]*img_height[12]*img_width[12]);
							break;
						case 13:
