...
{
	int i;
	unsigned int reuse_msmc_swap0, reuse_msmc_swap1, reuse_msmc_swap2,reuse_msmc_swap3,reuse_msmc_swap4,reuse_msmc_swap5, reuse_msmc_swap6;
//	reuse_msmc_swap7, reuse_msmc_swap8, reuse_msmc_swap9;
...
//	s->io->output_img4 = (float*)snet_malloc(output_channel[3]*img_height[4]*img_width[4] * sizeof(float), &reuse_msmc_swap9);     //共享 56x56x64 784KB
...

	{
		...
		s->weight->weight10 = (float *)snet_malloc(3*3*channel_group[9][core][0]* sizeof(float), &r2_startHeapAddress);//3*3*256 1.12K
		s->bias->bias10 = (float *)snet_malloc(channel_group[9][core][0] * sizeof(float), &r2_startHeapAddress);
		s->weight->weight11 = (float *)snet_malloc(input_channel[10]*channel_group[10][core][2]* sizeof(float), &r2_startHeapAddress);//256*256 32K
		s->bias->bias11 = (float *)snet_malloc(channel_group[10][core][2] * sizeof(float), &r2_startHeapAddress);

		s->weight->weight12 = (float *)snet_malloc(3*3*channel_group[11][core][0]* sizeof(float), &r2_startHeapAddress);//3*3*256 1.12K
		s->bias->bias12 = (float *)snet_malloc(channel_group[11][core][0] * sizeof(float), &r2_startHeapAddress);
		s->weight->weight13 = (float *)snet_malloc(input_channel[12]*channel_group[12][core][2]* sizeof(float), &r2_startHeapAddress);//256*512 64K
		s->bias->bias13 = (float *)snet_malloc(channel_group[12][core][2] * sizeof(float), &r2_startHeapAddress);

		s->weight->weight14 = (float *)snet_malloc(3*3*channel_group[13][core][0]* sizeof(float), &r2_startHeapAddress);//3*3*512 2.25K
		s->bias->bias14 = (float *)snet_malloc(channel_group[13][core][0] * sizeof(float), &r2_startHeapAddress);
		...
		s->weight->weight15 = (float *)snet_malloc(input_channel[13]*channel_group[13][core][2]* sizeof(float), &r3_startHeapAddress);//512*512 128K
		s->bias->bias15 = (float *)snet_malloc(channel_group[13][core][2] * sizeof(float), &r3_startHeapAddress);
		s->weight->weight16 = (float *)snet_malloc(3*3*channel_group[13][core][0]* sizeof(float), &r3_startHeapAddress);//3*3*512 2.25K
		s->bias->bias16 = (float *)snet_malloc(channel_group[13][core][0] * sizeof(float), &r3_startHeapAddress);
		s->weight->weight17 = (float *)snet_malloc(input_channel[13]*channel_group[13][core][2]* sizeof(float), &r3_startHeapAddress);//512*512 128K
		s->bias->bias17 = (float *)snet_malloc(channel_group[13][core][2] * sizeof(float), &r3_startHeapAddress);




		s->weight->weight18 = (float *)snet_malloc(3*3*channel_group[13][core][0]* sizeof(float), &r4_startHeapAddress);//3*3*512 2.25K
		s->bias->bias18 = (float *)snet_malloc(channel_group[13][core][0] * sizeof(float), &r4_startHeapAddress);
		s->weight->weight19 = (float *)snet_malloc(input_channel[13]*channel_group[13][core][2]* sizeof(float), &r4_startHeapAddress);//512*512 128K
		s->bias->bias19 = (float *)snet_malloc(channel_group[13][core][2] * sizeof(float), &r4_startHeapAddress);

		s->weight->weight20 = (float *)snet_malloc(3*3*channel_group[13][core][0]* sizeof(float), &r4_startHeapAddress);//3*3*512 2.25K
		s->bias->bias20 = (float *)snet_malloc(channel_group[13][core][0] * sizeof(float), &r4_startHeapAddress);



		s->weight->weight21 = (float *)snet_malloc(input_channel[13]*channel_group[13][core][2]* sizeof(float), &r5_startHeapAddress);//512*512 128K
		s->bias->bias21 = (float *)snet_malloc(channel_group[13][core][2] * sizeof(float), &r5_startHeapAddress);
		s->weight->weight22 = (float *)snet_malloc(3*3*channel_group[13][core][0]* sizeof(float), &r5_startHeapAddress);//3*3*512 2.25K
		s->bias->bias22 = (float *)snet_malloc(channel_group[13][core][0] * sizeof(float), &r5_startHeapAddress);
		s->weight->weight23 = (float *)snet_malloc(input_channel[13]*channel_group[13][core][2]* sizeof(float), &r5_startHeapAddress);//512*512 128K
		s->bias->bias23 = (float *)snet_malloc(channel_group[13][core][2] * sizeof(float), &r5_startHeapAddress);




		s->weight->weight24 = (float *)snet_malloc(3*3*channel_group[14][core][0]* sizeof(float), &r6_startHeapAddress);//3*3*512 2.25K
		s->bias->bias24 = (float *)snet_malloc(channel_group[14][core][0] * sizeof(float), &r6_startHeapAddress);
		s->weight->weight25 = (float *)snet_malloc(input_channel[15]*channel_group[15][core][2]* sizeof(float), &r6_startHeapAddress);//512*1024 256K
		s->bias->bias25 = (float *)snet_malloc(channel_group[15][core][2] * sizeof(float), &r6_startHeapAddress);
		s->weight->weight26 = (float *)snet_malloc(3*3*channel_group[16][core][0]* sizeof(float), &r6_startHeapAddress);//3*3*1024 4.5K
		s->bias->bias26 = (float *)snet_malloc(channel_group[16][core][0] * sizeof(float), &r6_startHeapAddress);




		s->weight->weight27 = (float *)snet_malloc(input_channel[17]*channel_group[17][core][2]* sizeof(float), &r7_startHeapAddress);//1024*512 256K
		s->bias->bias27 = (float *)snet_malloc(channel_group[17][core][2] * sizeof(float), &r7_startHeapAddress);



		s->weight->weight28 = (float *)snet_malloc(input_channel[18]*channel_group[18][core][2]* sizeof(float), &r8_startHeapAddress);//1024*512 256K
		s->bias->bias28 = (float *)snet_malloc(channel_group[18][core][2] * sizeof(float), &r8_startHeapAddress);
