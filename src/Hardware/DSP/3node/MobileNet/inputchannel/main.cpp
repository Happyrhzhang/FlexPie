...
//				}
...
#if ps
				//ps
				if((DeviceId == 1 && step < 27 && step % 2 == 0))
				{
					switch (step)
					{
						case 0:
				...
				if((DeviceId == 3 && step < 27 && step % 2 == 0))
				{
					switch (step)
					{
						case 0:
				...
				if((DeviceId == 0 && step < 27 && step % 2 == 0))
				{
					...
					for(int j = 0;j < 2;j++)
					{
						...
						{
							case 0:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->output_img1, (uint32_t)s->io->output_img1, output_channel[0]*img_height[1]*img_width[1]);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->output_img1, (uint32_t)s->io->output_img1, output_channel[0]*img_height[1]*img_width[1]);
								break;
							case 2:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)], (uint32_t)s->io->send_ddr[((1+j+5) % 4)], output_channel[2]*img_height[3]*img_width[3] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)], (uint32_t)s->io->send_ddr[((3+j+5) % 4)], output_channel[2]*img_height[3]*img_width[3] * 4);
								break;
							case 4:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)], (uint32_t)s->io->send_ddr[((1+j+5) % 4)], output_channel[4]*img_height[5]*img_width[5] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)], (uint32_t)s->io->send_ddr[((3+j+5) % 4)], output_channel[4]*img_height[5]*img_width[5] * 4);
								break;
							case 6:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)], (uint32_t)s->io->send_ddr[((1+j+5) % 4)], output_channel[6]*img_height[7]*img_width[7] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)], (uint32_t)s->io->send_ddr[((3+j+5) % 4)], output_channel[6]*img_height[7]*img_width[7] * 4);
								break;
							case 8:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)], (uint32_t)s->io->send_ddr[((1+j+5) % 4)], output_channel[8]*img_height[9]*img_width[9] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)], (uint32_t)s->io->send_ddr[((3+j+5) % 4)], output_channel[8]*img_height[9]*img_width[9] * 4);
								break;
							case 10:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[10]*img_height[11]*img_width[11] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[10]*img_height[11]*img_width[11] * 4);
								break;
							case 12:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[12]*img_height[13]*img_width[13] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[12]*img_height[13]*img_width[13] * 4);
								break;
							case 14:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[13]*img_height[13]*img_width[13] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[13]*img_height[13]*img_width[13] * 4);
								break;
							case 16:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[13]*img_height[13]*img_width[13] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[13]*img_height[13]*img_width[13] * 4);
							...
							case 20:
								...
								break;
							case 22:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[13]*img_height[14]*img_width[14] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[13]*img_height[14]*img_width[14] * 4);
								break;
							case 24:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[15]*img_height[16]*img_width[16] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[15]*img_height[16]*img_width[16] * 4);
								break;
							case 26:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[17]*img_height[18]*img_width[18] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[17]*img_height[18]*img_width[18] * 4);
								break;
							case 27:
								SrioSendData(DeviceId, 1,  (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , (uint32_t)s->io->send_ddr[((1+j+5) % 4)] , output_channel[18]*img_height[19]*img_width[19] * 4);
								SrioSendData(DeviceId, 3,  (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , (uint32_t)s->io->send_ddr[((3+j+5) % 4)] , output_channel[18]*img_height[19]*img_width[19] * 4);
								break;
							default:
								break;
						}
				...
				for(int i = 0;i < 3;i+=2)
				{
					...
					{
						case 0:
							SrioSendData(DeviceId, (DeviceId + i + 1) % 4,  (uint32_t)s->io->output_img1, (uint32_t)s->io->output_img1, output_channel[0]*img_height[1]*img_width[1]);
							break;
						case 2:
