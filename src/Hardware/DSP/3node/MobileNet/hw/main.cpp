...
//						}
					...
					case 11:
						...
						break;
					case 13:
						readdata(s->io->tiling_output, s->io->tiling_buffer_read, s->io->tiling_input, 1, 14, img_tiling[step][DeviceId][1]-2, 512/8);//后面四个数字需要每层核对
						break;
					case 15:
						readdata(s->io->tiling_input, s->io->tiling_buffer_read, s->io->tiling_output, 1, 14, img_tiling[step][DeviceId][1]-2, 512/8);//后面四个数字需要每层核对
						break;
					case 17:
						readdata(s->io->tiling_output, s->io->tiling_buffer_read, s->io->tiling_input, 1, 14, img_tiling[step][DeviceId][1]-2, 512/8);//后面四个数字需要每层核对
						break;
					...
					case 23:
						...
						break;
					case 25:
						readdata(s->io->tiling_output, s->io->tiling_buffer_read, s->io->tiling_input, 1, 7, img_tiling[step][DeviceId][1]-2, 1024/8);//这层不太对
						break;
					default:
						break;
				}
