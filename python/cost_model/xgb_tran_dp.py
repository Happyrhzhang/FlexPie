...
with open(args.csvname, encoding='UTF-8') as fileObject:
    for line in fileObject:
        ...
        data.append(line_split[0:2])
        labels.append(line_split[2])
        # data1.append(line_split[0])
...
xgb_model.save_model('xgb_tran_dp.model')
# xgb_model2=xgb.Booster(model_file='xgbtrannew.model')
